...
export type ReviewReviewDocumentResponse = (ReconciliationRecordPublic);

export type ReviewGetAuditTrailData = {
    documentId: string;
};

export type ReviewGetAuditTrailResponse = (Array<ReconciliationRecordPublic>);

export type ReviewAskAiQuestionData = {
    documentId: string;
